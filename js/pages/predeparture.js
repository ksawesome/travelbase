...
const DEFAULT_PREDEPARTURE = {
  phases: [
    ...
    { id:'F', name:'Operational Prep (2-4 weeks before)', deadline:'2026-06-01T23:59:00+05:30', tasks:[
      { id:'pf1', name:'Secure housing near UB North Campus', completed:false, deadline:'2026-06-01T23:59:00+05:30', priority:'critical', notes:'Find accommodation — check UB off-campus listings, Craigslist, Facebook groups' },
      ...
      { id:'pf6', name:'Schedule psych appointment — get 2 months of medicines + valid prescription for US customs', completed:false, deadline:'2026-06-01T23:59:00+05:30', priority:'critical', notes:'Prescription must be in English with generic drug names, needed for customs clearance' },
      { id:'pf7', name:'Get traveller\'s insurance policy', completed:false, deadline:'2026-06-05T23:59:00+05:30', priority:'critical', notes:'Must cover full stay in US — compare plans (ICICI Lombard, Bajaj Allianz, etc.)' },
    ]},
    { id:'G', name:'Final Week Prep', deadline:'2026-06-08T23:59:00+05:30', tasks:[
      ...
      { id:'pg5', name:'Travel insurance active from June 8', completed:false, deadline:'2026-06-07T23:59:00+05:30', priority:'critical', notes:'Ensure traveller\'s insurance policy is activated and printed' },
      ...
      { id:'pg15', name:'Check and activate eSIM in India before travel', completed:false, deadline:'2026-06-07T23:59:00+05:30', priority:'high', notes:'Test eSIM activation while still in India — verify carrier compatibility (Airtel/Jio eSIM or US T-Mobile eSIM)' },
